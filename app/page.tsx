  ...
  return (
    <div className="bg-[#020617] text-slate-300 font-sans selection:bg-accent-500 selection:text-white overflow-x-hidden relative min-h-screen">
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] left-[20%] w-[30%] h-[30%] bg-blue-600/20 rounded-full blur-[100px] animate-blob [animation-delay:4000ms]"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-1 p-1 bg-white/5 rounded-full border border-white/5">
              ...
              <a href="#propos" className="px-5 py-2 text-sm font-medium text-slate-300 hover:text-white hover:bg-white/10 rounded-full transition-all">À propos</a>
            </div>
              ...
              <div className="relative w-full aspect-square max-w-[500px] mx-auto animate-float">
                ...
                <div className="absolute bottom-20 -left-4 glass-card p-6 rounded-2xl w-72 transform -rotate-3 z-30 shadow-2xl shadow-brand-900/50">
                  ...
                  <div className="flex items-end gap-2 h-16">
                    <div className="w-1/5 bg-brand-500/20 rounded-t h-[40%]"></div>
                    <div className="w-1/5 bg-brand-500/40 rounded-t h-[60%]"></div>
                    <div className="w-1/5 bg-brand-500/60 rounded-t h-[50%]"></div>
                    <div className="w-1/5 bg-brand-500/80 rounded-t h-[80%]"></div>
                ...
                <div className="absolute inset-0 m-auto w-48 h-48 bg-slate-900 rounded-full border border-white/10 flex items-center justify-center z-10 shadow-[0_0_50px_rgba(59,130,246,0.3)]">
                  <div className="w-32 h-32 bg-gradient-to-br from-brand-600 to-accent-600 rounded-full flex items-center justify-center animate-pulse">
                    <svg className="w-16 h-16 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                  </div>
                </div>
                <svg className="absolute inset-0 w-full h-full animate-spin-slow opacity-20" viewBox="0 0 100 100">
                  <circle cx="50" cy="50" r="48" stroke="white" strokeWidth="0.5" strokeDasharray="4 4" fill="none"></circle>
                  <circle cx="50" cy="2" r="2" fill="white"></circle>
                </svg>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
            <div className="md:col-span-2 group relative overflow-hidden rounded-3xl bg-slate-800/50 border border-white/5 hover:border-brand-500/50 transition-all duration-300">
              <div className="absolute inset-0 bg-gradient-to-br from-brand-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="absolute right-0 top-0 w-64 h-64 bg-brand-500/10 rounded-full blur-3xl -mr-16 -mt-16 group-hover:bg-brand-500/20 transition-all"></div>
            ...
            <div className="md:col-span-1 group relative overflow-hidden rounded-3xl bg-slate-800/50 border border-white/5 hover:border-accent-500/50 transition-all duration-300">
              <div className="absolute inset-0 bg-gradient-to-br from-accent-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="p-8 h-full flex flex-col justify-between relative z-10">
            ...
            <div className="md:col-span-1 group relative overflow-hidden rounded-3xl bg-slate-800/50 border border-white/5 hover:border-pink-500/50 transition-all duration-300">
              <div className="absolute inset-0 bg-gradient-to-br from-pink-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="p-8 h-full flex flex-col justify-between relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-brand-600 to-accent-600 rounded-2xl blur-lg opacity-40 transform rotate-2"></div>
      ...
      <section id="contact" className="py-24 relative z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card rounded-3xl p-1 overflow-hidden relative">
            ...
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-accent-600/20 rounded-full blur-3xl -ml-20 -mb-20"></div>
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input type="text" className="w-full bg-slate-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all placeholder-slate-600" placeholder="Votre nom" />
                  </div>
                  <div className="space-y-1">
                    <label className="text-xs font-bold text-slate-500 uppercase">Entreprise</label>
                    <input type="text" className="w-full bg-slate-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all placeholder-slate-600" placeholder="Nom de PME" />
                  </div>
                </div>
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-500 uppercase">Courriel Pro</label>
                  <input type="email" className="w-full bg-slate-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all placeholder-slate-600" placeholder="vous@entreprise.ca" />
                </div>
                <div className="space-y-1">
                  <label className="text-xs font-bold text-slate-500 uppercase">Défi principal</label>
                  <textarea rows={3} className="w-full bg-slate-800/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all placeholder-slate-600 resize-none" placeholder="Ex: Trop de saisie manuelle..."></textarea>
                </div>
                <button type="button" className="w-full py-4 bg-white text-slate-900 font-bold rounded-xl hover:bg-slate-200 transition-all shadow-lg hover:-translate-y-1"> Demander mon audit gratuit </button>
              </form>
            </div>
          </div>
        </div>
            ...
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center gap-2 mb-6">
                <div className="w-8 h-8 bg-gradient-to-tr from-brand-600 to-accent-600 rounded-lg flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"></path><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"></path><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"></path></svg>
                </div>
                <span className="font-heading font-bold text-white text-lg">Synapse IA</span>
              </div>
              <p className="text-slate-500 text-sm leading-relaxed"> L'intelligence artificielle accessible et efficace pour les entreprises de Québec et Lévis. </p>
            </div>
            <div>
              <h4 className="font-bold text-white mb-6">Solutions</h4>
              <ul className="space-y-4 text-sm text-slate-400">
                <li><a href="#" className="hover:text-brand-400 transition-colors">Automatisation</a></li>
                <li><a href="#" className="hover:text-brand-400 transition-colors">Analyse de données</a></li>
                <li><a href="#" className="hover:text-brand-400 transition-colors">Consultation</a></li>
              </ul>
            </div>
            <div>
